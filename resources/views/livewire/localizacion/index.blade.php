<div class="h-full overflow-y-auto">
        ...
        <div class="px-6 overflow-y-auto max-h-[60vh] sm:max-h-full">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                ...
                <tbody>
                    ...
                    <tr wire:key="localizacion-{{ $dato->id }}"
                        ...
                        <td class="px-6 py-2 flex justify-center items-center gap-2">
                            @livewire('Localizacion.Edit', ['dato' => $dato], key('edit-' . $dato->id))
    ...
    @push('js')
    <script>
        // Confirmar eliminación de la localización
        Livewire.on('destroy', event => {
            Swal.fire({
                title: "¿Estás seguro de eliminar la localización?",
                text: "Localización: " + event.nombre,
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    // Disparar el evento de Livewire para intentar eliminar la localización
