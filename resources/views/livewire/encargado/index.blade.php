<div class="h-full overflow-y-auto">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                <thead class="text-xs text-white uppercase bg-blue-tec dark:bg-gray-700 dark:text-gray-400 w-full">
                    <tr>
                        ...
                        <th scope="col" class="cursor-pointer px-6 py-3 text-center" wire:click="order('apellido_p')">
                            <div class="flex items-center justify-center">
                                Apellidos
                                @if ($sort == 'apellido_p')
                                @if ($direc == 'asc')
                ...
                <tbody>
                    ...
                    <tr wire:key="encargado-{{ $dato->id }}"
                        ...
                        <td class="px-6 py-2 flex justify-center items-center gap-2">
                            ...
                            @livewire('Encargado.PasswordResetEncargado', ['dato' => $dato],
                            key('PasswordResetEncargado-' . $dato->id))
    ...
    <script>
        Livewire.on('destroy', event => {
                Swal.fire({
                    title: "¿Estás seguro de eliminar al encargado " + event.nombre + "?",
                    html: `<span style="color: red;">Al borrar un encargado, los materiales, préstamos y usuarios relacionados a este también se eliminarán.</span><br>
                           <span style"color: #333;">Si no quiere perder la información del encargado le recomendamos desabilitar la cuenta en la sección de edición.</span>`,
                    icon: "warning",
