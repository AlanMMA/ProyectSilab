<div class=" relative h-screen overflow-y-auto">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg h-full w-screen min-w-full">
        ...
        @if ($datos->count())
            <!-- Eliminar overflow independiente -->
        ...
        @endif
        <!-- Paginación -->
        <div class="px-6 py-3 w-full text-center">
