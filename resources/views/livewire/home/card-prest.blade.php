<div class="bg-white dark:bg-gray-800 relative " 
    x-data="{ open: false, days: @entangle('days') }">
    <div class="flex flex-col text-black dark:text-white text-lg font-semibold mb-3 sm:w-sm">
        <div class="flex justify-between w-full">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                class="ml-2 fill-black dark:fill-white cursor-pointer" @click="open = !open">
                <path
        ...
        <div x-show="open" @click.away="open = false"
            ...
            <input type="number" id="daysInput" x-model="days"  wire:model.debounce.500ms="days" min="1"
            ...
            <button x-show="days > 0" @click="open = false" wire:click="actualizarPrestamos"
    ...
    <div class="sm:grid sm:grid-cols-3 gap-4 items-start flex flex-col">
        ...
        <p class="text-center text-gray-500 dark:text-gray-300">Sin préstamos cercanos</p>
    @else
            ...
            <div class="flex flex-col items-start">
                ...
                @foreach ($prestamo->detalles as $detalle)
                    ...
                    <p class="ml-4 text-black dark:text-white text-xs font-normal bg-red-500">Vence:
                        {{ \Carbon\Carbon::parse($detalle->fecha_devolucion)->format('d/m/Y') }}
                    </p>
                @endforeach
            </div>
        @endforeach
