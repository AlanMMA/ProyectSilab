                ...
                @if ($alumnos->count())
                    <div class="px-6 overflow-y-auto max-h-[60vh] sm:max-h-full ">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                            <thead
                                class="text-xs text-white uppercase bg-blue-tec dark:bg-gray-700 dark:text-gray-400 w-full">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-center" wire:click="order('cantidad')">
                                        <div class="flex items-center justify-center">
                                            Apellido materno
                                        </div>
                                    </th>
